...
} > "test_co_temp_5.flash_bright.gen-s"
../../../utils/linter/linter fix "test_co_temp_5.flash_bright.gen-s" > /dev/null
...
} > "test_co_temp_5.ink_paper.gen-s"
../../../utils/linter/linter fix "test_co_temp_5.ink_paper.gen-s" > /dev/null

# attr_t mask_t p_flag a d f a_upd b_upd c_upd f_upd
input='0x84 0x49 0x00 0x14 0x00 0x98 0x04 0x04 0x00 0x44
0xb4 0x0c 0x55 0x14 0x01 0xc7 0x04 0x04 0x04 0x04
0x9c 0x9e 0xff 0x14 0x00 0x7f 0x04 0x04 0x00 0xa8
0x06 0x53 0xaa 0x14 0x01 0x3e 0x04 0x04 0x04 0xa8
0xcb 0x29 0x35 0x15 0x00 0xc9 0x01 0x01 0x00 0x20
0x25 0xa7 0x29 0x15 0x01 0x91 0x01 0x01 0x01 0x28
0x80 0xc2 0xca 0x15 0x00 0x69 0x01 0x01 0x00 0x8c
...
} > "test_co_temp_5.inverse_over.gen-s"
../../../utils/linter/linter fix "test_co_temp_5.inverse_over.gen-s" > /dev/null
