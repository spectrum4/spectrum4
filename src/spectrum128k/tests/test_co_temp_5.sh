...
# attr_t mask_t p_flag a d f attr_t_upd mask_t_upd p_flag_upd c_upd f_upd
...
0x5f 0xb9 0xcf 0x10 0x05 0xab 0x5d 0xb8 0xcf 0x05 0x8c'
{
  ...
  i=0
  echo "${input}" | while read attr_t mask_t p_flag a d f attr_t_upd mask_t_upd p_flag_upd c_upd f_upd; do
