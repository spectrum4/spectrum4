...
} > "test_po_scr.upperscreen.gen-s"
../../../utils/linter/linter fix "test_po_scr.upperscreen.gen-s" > /dev/null
...
} > "test_po_scr.lowerscreen.gen-s"
../../../utils/linter/linter fix "test_po_scr.lowerscreen.gen-s" > /dev/null
