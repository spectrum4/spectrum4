...
uart_init:
  ...
  ldr     x1, [x4, aux_base-mailbox_base]         // x1 = [aux_base] = 0xffff00003f215000 (rpi3) or 0xffff0000fe215000 (rpi4)
  ...
  ldr     x4, [x4, gpio_base-mailbox_base]        // x4 = [gpio_base] = 0xffff00003f200000 (rpi3) or 0xffff0000fe200000 (rpi4)
...
#   x0: char to send
# On exit:
#   x1: [aux_base] = 0xffff00003f215000 (rpi3) or 0xffff0000fe215000 (rpi4)
#   x2: Last read of [AUX_MU_LSR_REG] when waiting for bit 5 to be set
uart_send:
  adr     x1, mailbox_base                        // x1 = mailbox_base
  ldr     x1, [x1, aux_base-mailbox_base]         // x1 = [aux_base] = 0xffff00003f215000 (rpi3) or 0xffff0000fe215000 (rpi4)
1:
