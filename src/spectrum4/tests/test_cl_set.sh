...
} > "test_cl_set.printer.gen-s"
../../../utils/linter/linter fix "test_cl_set.printer.gen-s" > /dev/null
...
} > "test_cl_set.upperscreen.gen-s"
../../../utils/linter/linter fix "test_cl_set.upperscreen.gen-s" > /dev/null
...
} > "test_cl_set.lowerscreen.gen-s"
../../../utils/linter/linter fix "test_cl_set.lowerscreen.gen-s" > /dev/null
